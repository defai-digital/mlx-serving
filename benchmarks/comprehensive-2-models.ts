#!/usr/bin/env tsx
/**
 * Comprehensive benchmark for 2 models × 3 runs × 2 engines
 * Llama 3.1 70B and Qwen 3 30B
 */
...
const OUTPUT_DIR = 'results/comprehensive-2-models';
...
async function runBenchmark(
  ...
  try {
    ...
    execSync(
      ...
      { stdio: 'inherit', timeout: 1200000 } // 20 minute timeout
    );
...
function printResultsTable(allResults: BenchmarkResult[]): void {
  console.log('\n');
  console.log('╔════════════════════════════════════════════════════════════════════════════════╗');
  console.log('║          COMPREHENSIVE BENCHMARK RESULTS (2 Models × 3 Runs)                  ║');
  console.log('╚════════════════════════════════════════════════════════════════════════════════╝');
  console.log('');
  ...
  console.log('Weight Manager: Enabled (512MB warmup)');
  console.log('');
}
